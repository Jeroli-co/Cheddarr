...
Revision ID: 417f7a5239f5
Revises: 878bb2efd970
Create Date: 2020-09-06 00:15:44.783316
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column("id", sa.INTEGER(), nullable=False),
        sa.Column("plex_user_id", sa.INTEGER(), nullable=False),
        sa.Column("machine_id", sa.VARCHAR(length=128), nullable=True),
        sa.Column("machine_name", sa.VARCHAR(length=128), nullable=True),
        sa.ForeignKeyConstraint(
            ["id"],
            ["provider_config.id"],
        ),
