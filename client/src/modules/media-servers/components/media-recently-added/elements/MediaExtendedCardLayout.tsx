...
import { MediaCard } from "../../../../../utils/elements/media/MediaCard";
...
type MediaExtendedBoxBackgroundImageProps = {
  backgroundImage: string;
};

const MediaExtendedBoxBackgroundImage = styled.div<
  MediaExtendedBoxBackgroundImageProps
>`
  position: absolute;
  top: 0;
  left: 0;
...
type MediaExtendedCardLayoutProps = {
  media: IMediaServerMedia;
  onClose: () => void;
};

const MediaExtendedCardLayout = ({
  media,
  onClose,
}: MediaExtendedCardLayoutProps) => {
  return (
    <MediaExtendedBox>
