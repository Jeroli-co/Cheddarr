          ...
          <div id="action-column" className="column is-half-desktop">
            ...
            <div className="content">
              <p className="is-size-7">
                <FontAwesomeIcon icon={faExclamationCircle} /> Your friends
                mights not recognize you !
              </p>
              <button
                className="button is-primary"
                type="button"
                onClick={() => props.history.push(routes.CHANGE_USERNAME.url)}
              >
                Change username
              </button>
            </div>
            ...
            <div className="content">
              ...
              <button
                className="button is-primary"
                type="button"
                onClick={() => props.history.push(routes.CHANGE_PASSWORD.url)}
              >
                Change password
              </button>
            </div>
            ...
            <div className="content">
              ...
              <button
                className="button is-primary"
                type="button"
                onClick={() => props.history.push(routes.CHANGE_EMAIL.url)}
              >
                Change email
              </button>
            </div>
            ...
            <div className="content">
              ...
              <button
                ...
                type="button"
                onClick={() => props.history.push(routes.DELETE.url)}
              >
                Delete account
              </button>
            </div>
