...
const ResetPasswordForm = () => {
	...
	const PasswordsForm = () => {
		return (
			<form id="reset-password-form" className="PasswordForm" onSubmit={handleSubmit(resetPassword(token, getValues()))}>
				<div className="field">
	...
	return (
		<div className="ResetPasswordForm">
			...
			{ state &&
				(
					(state === messageTypes.ABLE_TO_RESET && <PasswordsForm/>) || <p>Error ... Pas content ...</p>
				)
			}
