...
const meta: Meta<typeof Button> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Button enables users to take actions, and make choices, with a single tap.",
      },
    },
  },
  argTypes: {
...
export const Disabled: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "The disabled state can be activated to prevent the user from interacting with the button.",
      },
    },
  },
  render: (args) => (
...
export const AsChild: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Use the `asChild` prop to apply the logic of the button on another element.",
      },
    },
  },
  render: (args) => (
