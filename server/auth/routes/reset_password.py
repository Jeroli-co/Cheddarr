...
def reset_password():
    ...
    raise InvalidUsage("Error when sending reset instructions", status_code=HTTPStatus.INTERNAL_SERVER_ERROR, payload=email_form.errors)
...
def confirm_reset(token):
    ...
    if session_token != user.session_token:
        raise InvalidUsage("Reset password unavailable", status_code=HTTPStatus.FORBIDDEN)
